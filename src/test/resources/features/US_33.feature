Feature:The desired option should be searchable from the Course overview provider dropdown
  @33
  @sez
  @1
  @team10
  Scenario: Relevant url should be enterable in Course overview url textbox
